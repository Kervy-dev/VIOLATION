...
{
    public partial class Minor_Offenses_Admin : Form
    {
        public Minor_Offenses_Admin()
        {
            InitializeComponent();
        }
        ...
        private void OpenClubsForm()
        {
            ...
            Major_Offenses_Admin clubsForm = new Major_Offenses_Admin(); // Create a new instance of the Clubs form
